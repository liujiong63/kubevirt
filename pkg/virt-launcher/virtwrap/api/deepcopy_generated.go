...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CurrentMemory) DeepCopyInto(out *CurrentMemory) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CurrentMemory.
func (in *CurrentMemory) DeepCopy() *CurrentMemory {
	if in == nil {
		return nil
	}
	out := new(CurrentMemory)
	in.DeepCopyInto(out)
	return out
}
